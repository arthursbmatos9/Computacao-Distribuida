...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in printing_pb2_grpc.py depends on'
...
class MutualExclusionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReleaseAccess = channel.unary_unary(
                ...
                response_deserializer=printing__pb2.EmptyResponse.FromString,
                _registered_method=True)
...
def add_MutualExclusionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReleaseAccess': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=printing__pb2.EmptyResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class MutualExclusionService(object):
    ...
    def ReleaseAccess(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            printing__pb2.EmptyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
